...
def run_validation(model, validation_ds, tokenizer_src, tokenizer_tgt, max_len, device, print_msg, global_step, writer, num_examples=2):
    ...
    # Size of the control window (use a default value)
    console_width = 80
...
def train_model(config):
    ...
    loss_fn = nn.CrossEntropyLoss(ignore_index=tokenizer_src.token_to_id('[PAD]'), label_smoothing=0.1) # Label smoothing decreases overfitting at the cost of a less confident decision
